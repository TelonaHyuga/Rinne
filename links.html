                    ...
                    <div style="padding-top: 15vw;">
                        <ul class="row">
                            <li class="tabelbanner">
                                <div class="THRTitel">
                                    <img src="./assets/image/THR_titel.webp" class="img_16_9">
                                </div>
                            </li>
                ...
                <div>
                    <div class="Panel" style="margin-top: 3vw;">
                        <ul class="row PanelP">
                            ...
                            <li class="PE">
                                <a href="/Rinne" style="cursor: pointer;">
                                    <img src="./assets/image/website.svg" class="img_1_1 PSVG">
                                </a>
                            </li>
                            <li class="PE">
                                <a href="https://www.youtube.com/@Telona_Hyuga" style="cursor: pointer;">
                                    <img src="./assets/image/youtube.svg" class="img_1_1 PSVG">
                                </a>
                            </li>
                            <li class="PE">
                            ...
                            <li class="PE">
                                <a href="https://pronouns.page/@Telona_Hyuga" style="cursor: pointer;">
                                    <img src="./assets/image/pronouns.svg" class="img_1_1 PSVG">
                                </a>
                            </li>
                            <li class="PE">
                                <a href="https://modrinth.com/user/TelonaHyuga" style="cursor: pointer;">

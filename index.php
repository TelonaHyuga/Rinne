            ...
            <div>
                ...
                <div>
                    <div class="RLC" style="margin-top: 3vw;">
                        ...
                        <ul class="TBB row">
                            <li>
                                <div class="PostBG scaller">
                                    <img src="./assets/image/RinneModel.webp" class="TeamI team">
                                </div>
                            </li>
                            <li class="TTB">
                                <div> <?php echo $translations[$currentLang]['post1']; ?></div>
                            </li>
                        </ul>
                        <!--Post end-->
                        ...
                        <ul class="TBB row">
                            <li>
                                <div class="PostBG scaller">
                                    <img src="./assets/image/op.webp" class="TeamI team">
                                </div>
                            </li>
                            <li class="TTB">
                                <div><?php echo $translations[$currentLang]['post2']; ?></div>
                            </li>
                        </ul>
                        <!--Post end-->
